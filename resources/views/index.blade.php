...
<html lang="en">
    <head>
        ...
        {{-- favicon --}}
        <link rel="icon" type="image/png" sizes="96x96" href="{{secure_asset('img/faviconn.png')}}">
    ...
    <body class="bg-light">
        ...
        <script src="{{ secure_asset('bootstrap-4.5.0/dist/js/bootstrap.bundle.min.js') }}"></script>
