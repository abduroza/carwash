        ...
        <div>
            ...
            <b-table striped hover :items="operators.data" :fields="fieldss">
                ...
                <template v-slot:cell(actions)="row">
                    ...
                    <router-link :to="{ name: 'operator.edit', params: {id: row.item.id} }" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i></router-link>
                    <!-- utk hapus pakai button -->
                    <button class="btn btn-danger btn-sm" @click="deleteOperator(row.item.id)"><i class="fa fa-trash"></i></button>
                </template>
            </b-table>
            <!-- pagination -->
            <div class="row">
